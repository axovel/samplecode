...
class IsBank
{
    ...
    public function requestBuilder($data)
    {
        ...
        $clientId  = $this->config->getClientIdIsbank();
        ...
        $rnd       = microtime();
        $storekey  = $this->config->getStoreKeyIsbank();
    ...
    {
        $userName    = $this->config->getApiUserIsbank();
        $apiPassword = $this->config->getApiPasswordIsbank();
        $clientId    = $this->config->getClientIdIsbank();
